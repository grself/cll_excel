...
% The following creates a simulated keystroke font. That is
% \keystroke{Esc} puts the letters ``Esc'' in a box that 
% resembles a keystroke.
...
% The following formats formulas and functions
\newcommand{\formatfunc}[1]{\textit{\textcolor{blue}{#1}}}
