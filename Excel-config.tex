...
% Cell Location
\definecolor{CellLoc}{HTML}{708090} %SlateGray
\newcommand{\fmtCellLocation}[1]{\textcolor{CellLoc}{\textbf{\textsf{#1}}}}

% Popup box names
\definecolor{Popup}{HTML}{CD853F} %Peru
\newcommand{\fmtPopupBox}[1]{\textcolor{Popup}{\textbf{\textsf{#1}}}}

% Popup buttons and other clicks in popup boxes
...
% Typed-in Text
\definecolor{Typing}{HTML}{2F4F4F} %DarkSlateGray
\newcommand{\fmtTyping}[1]{\textcolor{Typing}{\textsf{\textit{#1}}}}
