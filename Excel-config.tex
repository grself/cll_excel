...
\definecolor{Btn}{RGB}{136,3,145} %Purple
\newcommand{\fmtButton}[1]{\textcolor{Btn}{\textbf{\textit{#1}}}}

% Cell Location
\definecolor{CellLoc}{RGB}{255,69,0} %Orange
\newcommand{\fmtCellLocation}[1]{\textcolor{CellLoc}{\textbf{\textsf{#1}}}}

% Formulas and functions
\definecolor{Func}{RGB}{0,100,0} %Green
\newcommand{\fmtFunction}[1]{\textcolor{Func}{\textbf{\textsf{#1}}}}

% Ribbon Button (like Find and Autosum)
\definecolor{RbnBtn}{RGB}{0,206,209} %Turquois
\newcommand{\fmtRibbonButton}[1]{\textcolor{RbnBtn}{\textbf{\textsf{#1}}}}

% Ribbon Group
\definecolor{RbnGrp}{RGB}{160,82,45} %Sienna
\newcommand{\fmtRibbonGroup}[1]{\textcolor{RbnGrp}{\textbf{\textsf{#1}}}}

% Ribbon Tab
\definecolor{RbnTab}{RGB}{112,128,144} %Slate Gray
\newcommand{\fmtRibbonTab}[1]{\textcolor{RbnTab}{\textbf{\textsf{#1}}}}

% Workbook (file) name
\definecolor{WkbkName}{RGB}{184,134,11} %Golden rod
\newcommand{\fmtWorkbookName}[1]{\textcolor{WkbkName}{\textbf{\textsf{#1}}}}

% Worksheet name
\definecolor{WkShtName}{RGB}{85,107,47} %Olive
\newcommand{\fmtWorksheetName}[1]{\textcolor{WkShtName}{\textbf{\textsf{#1}}}}
