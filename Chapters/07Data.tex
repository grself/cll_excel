...
\begin{enumbox}
	\begin{enumerate}
		...
		\item Resize the chart using the following values. For each side of the chart, press the \fmtKeystroke{Alt} key while dragging the resize handle on the chart.
