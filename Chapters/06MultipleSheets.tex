...
\begin{enumbox}
	\begin{enumerate}
		...
		\item Hold the \fmtKeystroke{Shift} key down and click on the \fmtWorksheet{December} worksheet tab to group them.
	\end{enumerate}
\end{enumbox}
...
\begin{enumbox}
	\begin{enumerate}
		...
		\item Resize the pie chart using the values below. For each side of the chart, press the \fmtKeystroke{Alt} key while dragging the resize handle on the chart to make it ``lock into'' position.
