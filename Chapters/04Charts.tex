...
\begin{enumerate}
	...
	\item Click \fmtButton{Chart Tools Design $ \Rightarrow $ Chart Layouts $ \Rightarrow $ Move Chart}. (\fmtNewExcel{Excel 365} named this tab \textit{Chart Design}.) (\fmtNewExcel{Excel 365} named the tab \textit{Chart Design}.)
...
\begin{enumerate}
	...
	\item Click \fmtButton{Chart Tools Design $ \Rightarrow $ Select Data}. (\fmtNewExcel{Excel 365} named the tab \textit{Chart Design}.) This opens the \textit{Select Data Source} dialog box. The box at the top tells us the range that was selected, which looks fine. 
\end{enumerate}
