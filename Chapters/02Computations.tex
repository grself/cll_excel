...
\section{Statistical Functions}\label{ch02.2:statistical_functions}
...
\section{Functions for Personal Finance}\label{ch02.3:functions_personal}
...
5.   Press the \keystroke{Enter} key on your keyboard. The output of the SUM function in cell D12 on
...
7.   Press the \keystroke{Enter} key on your keyboard. The value of multiplying the monthly mortgage
...
14.   Press the \keystroke{Enter} key on your keyboard. The value of multiplying the monthly lease payments
...
5.   Type a closing parenthesis ) and press the \keystroke{Enter} key on your keyboard or simply press the \keystroke{Enter} key to close the function. The total for all annual expenses now appears on the worksheet.
...
10.   Press the \keystroke{Enter} key on your keyboard. This formula produces an output of \$1,942, indicating
...
5.   Press the \keystroke{F4} key on your keyboard. This adds an absolute reference to cell D2.
6.   Press the \keystroke{Enter} key. The result of the formula shows that total expenses consume 94.1% of our
net income.
7.   Click cell E6.
...
14. Type: Type the number 1, type a closing parenthesis ), and press the \keystroke{Enter} key. We will assume
...
19. Type an equal sign =. Click the Leases worksheet, click cell F10, and press the \keystroke{Enter} key.
...
/ for division. Click the Investments worksheet. Click cell B10 and press the \keystroke{Enter} key. This
